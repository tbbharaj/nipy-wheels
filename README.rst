...
be something like::
    ...
    wheel-uploader -r warehouse -u $CDN_URL -v -w ~/wheelhouse -t macosx nipy 0.4.0
    wheel-uploader -r warehouse -u $CDN_URL -v -w ~/wheelhouse -t manylinux1 nipy 0.4.0
...
* ``nipy`` is the root name of the wheel(s) to download / upload;
